...
- NetLLM 설계: 3가지 모듈로 구성
    ...
    3. 네트워킹 헤드: 기존 LLM의 LM헤드 대신, 과제별 변환기로서 직접적으로 과제에 맞는 답변(변수 범위 내) 생성
    ...
    4. DD-LRNA(Data-driven Low-Rank Networking Adaptation): 데이터 기반 적응 파이프라인 및 저차원 행렬로 파라미터 미세 조정(적은 학습 비용/메모리 소모)
